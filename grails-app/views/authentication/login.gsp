            ...
            <div class="row">
                <div class="col-sm-6 col-md-4 mx-auto">
                    ...
                    <div class="account-wall">
                        <g:img dir="images" file="logo.jpg" class="profile-img"/>
                        <g:form controller="authentication" action="doLogin" class="form-signin">
                            ...
                            <g:link controller="authentication" action="registration" class="btn btn-lg btn-primary btn-block">Change Password</g:link>
                        </g:form>
                    </div>
                </div>
            </div>
